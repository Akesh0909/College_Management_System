...
<html lang="en">
	<head>
    <meta charset="utf-8">
    <link rel="shortcut icon" href="$baseUrl/../Images/g1.jpg.png" type="image/x-icon">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark header-back sticky-top header-navbar-fonts">
      <a class="navbar-brand d-flex align-items-center" href="../index.php">
        <img src="../images/g1.jpg" class="logo-image" width="50" height="50">
        <h3 class="text-light text-uppercase ml-2">IIIT SONEPAT</h3>
      </a>
