...
<html lang="en">
	...
	<body>
		...
		<tr>
			...
			<td><a href="viewnotes2.php?viewid=<?php echo $row['N_id']; ?>"> <input type="button" Value="View" style="border-radius:0%"  class="btn btn-info btn-sm"  data-toggle="modal" data-target="#myModal"></a>
			</td>
		</tr>
		<?php
		$count++;}
