		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 main-background mb-2 w-100">
			<div class="sub-main">
                ...
                <div class="col-md-12 text-center">
                    ...
                    <a href="addnotes.php"><button  href="" type="submit" class="btn btn-primary" style="border-radius:0%">Add Notes</button></a>
                    <a href="managenotes.php"><button  href="" type="submit" class="btn btn-primary" style="border-radius:0%">Manage Notes</button></a>
                    </div>
                </div>
			</div>
		</main>
